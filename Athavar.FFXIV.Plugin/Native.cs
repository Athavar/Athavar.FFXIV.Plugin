...
namespace Athavar.FFXIV.Plugin
{
    ...
    public static class Native
    {
        ...
        static Native()
        {
            native = Environment.OSVersion.Platform switch
            {
        ...
        public enum KeyCode : ushort
        {
            ...
            /// <summary>
            /// Used to pass Unicode characters as if they were KeyCodetrokes. The Packet key value is the low word of a 32-bit virtual-key value used for non-keyboard input methods.
            /// </summary>
            Packet = 0xE7,
        ...
        private class Windows : INative
        {
            ...
            public void KeyUp(IntPtr hWnd, KeyCode keyCode)
            {
