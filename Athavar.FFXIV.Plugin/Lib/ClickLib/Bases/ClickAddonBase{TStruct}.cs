// <copyright file="ClickAddonBase{TStruct}.cs" company="Athavar">
...
public abstract unsafe class ClickAddonBase<TStruct> : ClickBase
    where TStruct : unmanaged
{
    ...
    /// <param name="which">Internal game click routing.</param>
    /// <param name="type">Event type.</param>
    protected static void ClickAddonStage(AtkUnitBase* addonBase, AtkStage* target, uint which, EventType type = EventType.MouseClick)
    {
