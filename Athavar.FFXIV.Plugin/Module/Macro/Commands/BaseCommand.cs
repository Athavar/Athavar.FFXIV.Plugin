...
namespace Athavar.FFXIV.Plugin.Module.Macro
{
    ...
    internal abstract class BaseCommand
    {
        ...
        /// </summary>
        public abstract IEnumerable<string> CommandAliase { get; }

        /// <summary>
        /// Gets the <see cref="MacroManager"/>.
        /// </summary>
        protected MacroManager Manager { get; private set; } = null!;

        /// <summary>
        /// Initializes the instance of the <see cref="BaseCommand"/> class.
        /// </summary>
        /// <param name="manager">The <see cref="MacroManager"/>.</param>
        public virtual void Init(MacroManager manager)
        {
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous operation. The task result contains a <see cref="TimeSpan" /> of the time that should be waited after the command.</returns>
