...
internal class RotationTab : Tab
{
    ...
    /// <inheritdoc />
    protected internal override string Name => "Rotation";

    /// <inheritdoc />
    protected internal override string Identifier => "Tab-RotationsOptions";
    ...
    private void DisplayRotationInfo()
    {
        ...
        {
            var rotations = node.Macro!.Rotation;
    ...
    private void DisplayRotationEdit()
    {
        ...
        if (ImGuiEx.IconButton(FontAwesomeIcon.FileImport, "Import from clipboard"))
        {
            ...
            node.Update(text);
            this.activeRotationContent = node.Macro!.CreateMacro(this.ClientLanguage);
        ...
        {
            this.editChanged = true;
            node.Update(this.activeRotationContent);
        }
    ...
    private void DisplayRotationNode(RotationNode node)
    {
        ...
        if (ImGui.IsItemClicked())
        {
            ...
            this.activeRotationNode.InitMarco();
            this.activeRotationContent = this.activeRotationNode.Macro!.CreateMacro(this.ClientLanguage);
            this.editChanged = false;
        }
