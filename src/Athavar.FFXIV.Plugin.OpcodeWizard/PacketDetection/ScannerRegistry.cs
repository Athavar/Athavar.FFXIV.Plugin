...
internal sealed class ScannerRegistry
{
    ...
    private void DeclareScanners()
    {
        ...
        this.RegisterScanner(
            ...
            dependency: Opcode.UpdateHpMpTp); // GP equals 10000
        ...
        this.RegisterScanner(
            Opcode.UpdateSearchInfo,
            string.Empty,
            PacketSource.Server,
            (packet, _) => IncludesBytes(packet.Data, searchBytes!),
            dependency: Opcode.SetSearchInfoHandler);
        this.RegisterScanner(
            Opcode.ExamineSearchInfo,
            ...
            dependency: Opcode.UpdateSearchInfo);
        ...
        this.RegisterScanner(
            ...
            "Please wait. This is updated during territory change.",
            PacketSource.Server,
            (packet, _) =>
            {
        ...
        */
        ...
        this.RegisterScanner(
            Opcode.MarketBoardSearchResult,
        ...
        this.RegisterScanner(
            ...
            (packet, _) => packet.PacketSize == 1080 &&
                           isDarkMatter(BitConverter.ToUInt32(packet.Data, Offsets.IpcData)),
            dependency: Opcode.MarketBoardItemListingCount);
        this.RegisterScanner(
        ...
        this.RegisterScanner(
            Opcode.MarketBoardPurchase,
            string.Empty,
            PacketSource.Server,
            (packet, _) => packet.PacketSize == 48 &&
                           isDarkMatter(BitConverter.ToUInt32(packet.Data, Offsets.IpcData)),
            dependency: Opcode.MarketBoardPurchaseHandler);
        ...
        this.RegisterScanner(
            ...
            dependency: Opcode.InventoryModifyHandler);
        this.RegisterScanner(
            Opcode.InventoryTransactionFinish,
            "Please wait.",
            PacketSource.Server,
            (packet, _) => packet.PacketSize == 48 && BitConverter.ToUInt32(packet.Data, Offsets.IpcData) == inventoryModifyHandlerId,
            dependency: Opcode.InventoryModifyHandler);
        ...
        this.RegisterScanner(
            ...
            dependency: Opcode.RetainerInformation);

        //================
        this.RegisterScanner(
            Opcode.ItemMarketBoardInfo,
        ...
        this.RegisterScanner(
            ...
            dependency: Opcode.AirshipTimers);
        this.RegisterScanner(
            Opcode.AirshipExplorationResult,
        ...
        this.RegisterScanner(
            Opcode.SubmarineProgressionStatus,
        ...
        this.RegisterScanner(
            Opcode.SubmarineExplorationResult,
        ...
        //=================
        this.RegisterScanner(
            Opcode.IslandWorkshopSupplyDemand,
        ...
        this.RegisterScanner(
            Opcode.FateInfo,
            "Please enter a zone with F.A.T.E. If you are already in one, please wait for a new F.A.T.E. shows up.",
            PacketSource.Server,
            (packet, _) =>
            {
