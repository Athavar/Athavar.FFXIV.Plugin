// <copyright file="PatchExtensions.cs" company="Athavar">
...
{
    public static byte ToMajor(this Patch value) => (byte)((ushort)value / 100);
    ...
    public static Patch ToExpansion(this Patch value) => (Patch)(value.ToMajor() * 100);

    public static string ToVersionString(this Patch value) => value == Patch.Unknown ? "???" : $"{value.ToMajor()}.{value.ToMinor()}";

    public static string ToPatchName(this Patch value)
        => ((ushort)value / 10) switch
           {
               20 => "A Realm Reborn",
               21 => "A Realm Awoken",
