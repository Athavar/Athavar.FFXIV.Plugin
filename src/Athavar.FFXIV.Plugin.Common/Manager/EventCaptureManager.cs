...
public sealed class EventCaptureManager : IDisposable
{
    ...
    public EventCaptureManager(IDalamudServices dalamudServices, AddressResolver addressResolver)
    {
        ...
        this.actorControlSelfHook = dalamudServices.GameInteropProvider.HookFromAddress<ActorControlSelfDelegate>(addressResolver.ActorControlHandler, this.OnActorControl);
        this.actorControlSelfHook.Enable();
    }
