...
public static class Native
{
    ...
    public enum KeyCode : ushort
    {
        ...
        /// <summary>
        ///     Used to pass Unicode characters as if they were KeyCodetrokes. The Packet key value is the low word of a 32-bit
    ...
    /// <summary>
    ///     implements methodes to interact with native functions.
    /// </summary>
    private interface INative
    {
        ...
        void KeyDown(nint hWnd, KeyCode keyCode);
        ...
        /// <param name="hWnd">Pointer to windows handler.</param>
        /// <param name="keyCode">The key code.</param>
        void KeyUp(nint hWnd, KeyCode keyCode);
    }

    public static void KeyDown(nint hWnd, KeyCode key) => NativeInstance.KeyDown(hWnd, key);

    public static void KeyUp(nint hWnd, KeyCode key) => NativeInstance.KeyUp(hWnd, key);
    ...
    private class Windows : INative
    {
        ...
        public void KeyDown(nint hWnd, KeyCode keyCode) => SendMessage(hWnd, WmKeydown, (nint)keyCode, 0);

        public void KeyUp(nint hWnd, KeyCode keyCode) => SendMessage(hWnd, WmKeyup, (nint)keyCode, 0);
