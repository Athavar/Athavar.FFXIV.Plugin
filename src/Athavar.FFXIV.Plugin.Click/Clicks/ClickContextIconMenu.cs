...
public sealed class ClickContextIconMenu : ClickBase<ClickContextIconMenu, AddonContextIconMenu>
{
    ...
    public ClickContextIconMenu(nint addon = default)
        : base("ContextIconMenu", addon)
    {
    }

    public static implicit operator ClickContextIconMenu(nint addon) => new(addon);
    ...
    public static ClickContextIconMenu Using(nint addon) => new(addon);
