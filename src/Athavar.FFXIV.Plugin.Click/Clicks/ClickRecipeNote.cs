...
#pragma warning disable SA1134, SA1516, SA1600
    ...
    [ClickName("synthesis_material2_nq")]
    public void Material2Nq() => this.Material(1, false);

    [ClickName("synthesis_material3_nq")]
    public void Material3Nq() => this.Material(2, false);

    [ClickName("synthesis_material4_nq")]
    public void Material4Nq() => this.Material(3, false);

    [ClickName("synthesis_material5_nq")]
    public void Material5Nq() => this.Material(4, false);
    ...
    [ClickName("synthesis_material2_hq")]
    public void Material2Hq() => this.Material(1, true);

    [ClickName("synthesis_material3_hq")]
    public void Material3Hq() => this.Material(2, true);

    [ClickName("synthesis_material4_hq")]
    public void Material4Hq() => this.Material(3, true);

    [ClickName("synthesis_material5_hq")]
    public void Material5Hq() => this.Material(4, true);

    [ClickName("synthesis_material6_hq")]
    public void Material6Hq() => this.Material(5, true);
