...
public sealed class ClickGatheringMasterpiece : ClickBase<ClickGatheringMasterpiece>
{
    ...
    public ClickGatheringMasterpiece(nint addon = default)
        : base("GatheringMasterpiece", addon)
    {
    }

    public static implicit operator ClickGatheringMasterpiece(nint addon) => new(addon);
    ...
    public static ClickGatheringMasterpiece Using(nint addon) => new(addon);
